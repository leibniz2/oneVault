 ...
 * {@link Legal.OnFragmentInteractionListener} interface
...
public class Legal extends Fragment {
     ...
     * @return A new instance of fragment Legal.
     */
    public static Legal newInstance(String param1, String param2) {
...
//        notice.setText(GooglePlayServicesUtil.getOpenSourceSoftwareLicenseInfo(getActivity()));

        ((MainActivity)getActivity()).Hide(1500 , true);

        getActivity().setTitle("Legal Notice");
